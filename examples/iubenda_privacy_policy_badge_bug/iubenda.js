...
function (e, t) {
  ...
  function l(e, i, n, r, o, l, s, d, u, c, p, h, b, g, m) {
    ...
    L = w(L, b);
    var S = null,
    M = '<html><head><title>' + A + '</title><meta name="viewport" content="width=device-width"><link type="text/css" rel="stylesheet" href="' + u + '" media="screen" />' + '<script type="text/javascript" src="' + d + '"></script></head>' + '<body onload="try{_iub.ifr.iubendaStartBadge({' + (S ? 'iFrUrl:\'' + S + '\',' : '') + 'useProtocol:\'' + b + '\',zIndex:\'' + g + '\',overflow:\'' + m + '\',cdnBaseUrl:\'' + s + '\'});}catch(exc){console.log(\'IUBENDA: error while loading [iubendaStartBadge]. Please contact info@iubenda.com for support and troubleshooting.\')}"><a href="' + L + '" class="' + i + ' ' + (l ? 'no-brand' : '') + ' ' + (h ? 'iub-anchor' : '') + '" id="i_badge-link" title="' + v + '" target="_parent" >' + y + '</a></body></html>';
    return E.write(M),
    E.close(),
    c || a(k, o),
    k
